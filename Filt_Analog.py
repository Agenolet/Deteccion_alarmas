...
FP1 = 4500                  # Frec. límite para la banda de paso en Hz (frec. de corte en Butterworth, frec. de fin de ripple para Chebyshev)
FS1 = 8000                  # Frec. límite para la banda de rechazo en Hz
AT1 = 34                    # Atenuación mínima en dB en la banda de rechazo (a partir de FS1)
...
f1, h_sim_1, _ = import_AC_LTSpice('./LTspice/NUEVO_SallenKey_PasaBajos.txt')
f2, h_sim_2, _ = import_AC_LTSpice('./LTspice/NUEVO_MultiReali_PasaBajos.txt')
