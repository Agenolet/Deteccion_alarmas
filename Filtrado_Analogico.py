...
FP1 = 1000                  # Frec. límite para la banda de paso en Hz (frec. de corte en Butterworth, frec. de fin de ripple para Chebyshev)
FS1 = 3000                  # Frec. límite para la banda de rechazo en Hz
AT1 = 50                    # Atenuación mínima en dB en la banda de rechazo (a partir de FS1)
...
f1, h_sim_1, _ = import_AC_LTSpice('./Archivos para codigos/SallenKey_PasaBajos.txt')
f2, h_sim_2, _ = import_AC_LTSpice('./Archivos para codigos/MFB_PasaBajos.txt')
