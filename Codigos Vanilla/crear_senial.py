...
def crear_senial(gNHT50, gPB, gDC, gN, nNHT50, nPB, nDC, sC, sW=False):
    ...
    t: vector de tiempos
    """
    fs, data_PB840 = wavfile.read("Puritan_Bennett_840_x1.wav")
    fs, data_NHT50 = wavfile.read("Newport_HT50_x1.wav")
    fs, data_DC = wavfile.read("Dragger_Carina_x1.wav")
    fs, data_UTI = wavfile.read("UTI.wav")
